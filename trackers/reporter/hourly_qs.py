...
while True:
    ...
    activity = input("Activities (Schoolwork/In Class/Leisure/Feedly/Studying/Errands/Eating/Cooking/Reading/Resting/Chatting/Email/With Friends/with k/Therapy): ")
